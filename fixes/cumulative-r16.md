...
headphones or the TAS2557 speaker. Wired headphones remain the antenna. The
optional [FM radio application](fm-radio.md) adds full-band scanning, saved
stations, volume control and Plasma launchers; qv4l2 remains available as the
lower-level receiver control.
...
The release also updates the TAS2557 UCM profile, adds qv4l2 and the lightweight
FM application, and includes three small FM configuration files.
Compatibility, checksums, installation and rollback instructions are in the
